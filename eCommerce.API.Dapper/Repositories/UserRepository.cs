...
namespace eCommerce.API.Dapper.Repositories {
    public class UserRepository : IUserRepository {
        ...
        public List<User> GetUsers() {
            string command = "SELECT Id, Nome AS Name, Email, Sexo AS Gender, RG, CPF, Filiacao AS Filiation, " +
                "Situacao AS Situation, DataCad AS RegDate FROM Usuarios";
            return _connection.Query<User>(command).ToList();
        }
